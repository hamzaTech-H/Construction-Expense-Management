...
const InvoicesPage: React.FC<InvoicesPageProps> = ({ currentProject, onBack, onInvoiceClick }) => {
  ...
  const [deleteInvoiceName, setDeleteInvoiceName] = useState<string>('');
  ...
  const confirmDeleteInvoice = (invoice: Invoice) => {
    ...
    setDeleteInvoiceName(invoice.name);
          ...
          <div className="bg-white p-6 rounded-lg w-96 shadow-lg">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Are you sure you want to delete <strong>"{deleteInvoiceName}"</strong>? 
                This action cannot be undone and will also delete all associated expenses and payments.
              </p>
